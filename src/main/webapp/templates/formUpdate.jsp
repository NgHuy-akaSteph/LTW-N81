...
<div class="container mt-4">
    ...
    <form action="/update" method="post">
        <div class="mb-3">
            ...
            <input type="number" id="id" name="id" value="${category.id}" class="form-control" readonly>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="describe" name="describe" value="${category.describe}" class="form-control" required>
        </div>
